...
for M0 = 0:0.2:2
        ...
        K=1:1:10;            %Creats and stores M0 values into array
        M0(K,1)=0.2*K;
    ...
    for Tt4 = 1400:100:2400

 

        for piC = 5:1:30
            
            L = 1:1:10;      %Creats and stores piC values into array
            piC(L,1)=L;
            ...
            summary = table(Sp_Thrst,SFC,nTH,nO); 
