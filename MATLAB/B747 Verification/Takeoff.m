%% Created by Luke Patterson for the analysis of the Boeing 747 during the takeoff run
clear
close all
clc
...
begin.Altitude = 50; % Altitude in feet, condition for takeoff is a 50 ft obstacle
begin.Units = 'FPS';
begin = begin.SetSpeed('V',247.35); % Takeoff velocity in ft/s
...
grid on
title('Total Vehicle C_D vs. AoA')
xlabel('Angle of Attack, degrees')
