...
b = 1;
for m = 0.01:0.01:0.06
    p = 0.4;
    t = 0.21;
    NACAName = Specs2NACA(m,p,t);
    MainWing.RootAirfoil = NACA4WingSection(char(NACAName),MainWing.Rc,128);
    n = 1;
...
legend('NACA 1421','NACA 2421','NACA 3421','NACA 4421','NACA 5421','NACA 6421','Location','SouthEast')
